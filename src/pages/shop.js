        ...
        <div className='container mb-3' style={{ marginTop: "10px" }}>
          <div className=' d-flex  justify-content-center w-100'>
            <div className="input-group mb-3" style={{ width: "20rem" }} >
              <input type="text" className="form-control" placeholder='Tìm kiếm sản phẩm' onChange={e => setSearchName(e.target.value)} />
              <button className="btn btn-outline-secondary bg-success-subtle" onClick={(e) => search(e, searchname)} >Tìm kiếm</button>
            </div>
          </div>
